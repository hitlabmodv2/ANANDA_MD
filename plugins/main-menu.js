...
%readmore`.trim(),
	...
	const btn = new Button()
		.setImage(fs.readFileSync('./media/menu.jpg')) 
		.setBody(style(text.replace(new RegExp(`%(${Object.keys(replace).sort((a, b) => b.length - a.length).join`|`})`, 'g'), (_, name) => '' + replace[name]))) 
		.setFooter(global.namebot) 
		.setButton("single_select", {
							title: 'List Menu',
							sections: [
								{
									rows,
		...
		.addReply("Owner", _p + "owner") 
		.addReply("Script BOT", _p + "script") 
		.addReply("Terms of Service", _p + "rules") 
		.setButton("galaxy_message", {
  "icon": "REVIEW",
  "mode": "published",
  "flow_message_version": "3",
  "flow_token": "1:1307913409923914:293680f87029f5a13d1ec5e35e718af3",
  "flow_id": "1307913409923914",
  "flow_cta": global.namebot,
