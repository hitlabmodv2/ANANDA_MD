// Suppress libsignal/Baileys noisy logs
...
function _shouldSuppress(args) {
        ...
        if (typeof first === 'string') {
                for (const p of _SUPPRESS_PATTERNS) if (p.test(first)) return true;
        }
        // Drop multi-line dumps that look like SessionEntry object printouts
